...
<a href="/relatorio/alimentacao">??? Relatório de Alimentação</a>
</div>
...
def alimentacao():
    ...
    return render("alimentacao","??? Registrar Alimentação",sucesso=request.args.get("ok")=="1")
...
def rel_alimentacao():
    inicio=request.args.get("inicio","")
    fim=request.args.get("fim","")
    return render("alimentacao_rel","??? Relatório de Alimentação",
