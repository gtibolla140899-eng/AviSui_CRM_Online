...
:root{
    --avisui-red:#d71920;
    --avisui-red-dark:#9e1117;
    --avisui-black:#07090c;
    --avisui-card:rgba(18,21,27,.88);
    --avisui-border:rgba(255,255,255,.10);
    --avisui-text:#f5f5f5;
    --avisui-muted:#aeb4bd;
}
...
body{
    margin:0 !important;
    min-height:100vh;
    color:var(--avisui-text) !important;
    background:
        linear-gradient(rgba(5,7,10,.88),rgba(5,7,10,.94)),
        url("https://images.unsplash.com/photo-1548550023-2bdb3c5beed7?auto=format&fit=crop&w=1800&q=85")
...
.header,
.topo{
    background:rgba(5,7,10,.90) !important;
    backdrop-filter:blur(14px);
    border-bottom:2px solid var(--avisui-red) !important;
...
table,
section{
    background:var(--avisui-card) !important;
    border:1px solid var(--avisui-border) !important;
...
select:focus,
textarea:focus{
    border-color:var(--avisui-red) !important;
...
button{
    ...
    background:linear-gradient(135deg,#e51b23,#a80f15) !important;
    color:#fff !important;
    font-weight:800 !important;
    cursor:pointer !important;
    box-shadow:0 8px 22px rgba(215,25,32,.25) !important;
    transition:.2s ease !important;
}

button:hover{
    transform:translateY(-1px);
    box-shadow:0 12px 28px rgba(215,25,32,.35) !important;
}
...
th{
    background:var(--avisui-red) !important;
    color:#fff !important;
